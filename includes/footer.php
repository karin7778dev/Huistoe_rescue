    ...
    <div class="footer-bar">
      <div class="footer-left">
        ...
        <?php if (!empty($_SESSION['is_admin'])):
          ...
          <span class="visit-counter">Total visits: <?= htmlspecialchars($visitCount) ?></span>
        <?php endif; ?>
      </div>
      ...
      <nav aria-label="Footer navigation" class="footer-nav">
        ...
        <ul class="footer-menu footer-menu-main">
          ...
          <li><a href="<?= BASE_URL ?>/index.php?page=donations">Support Us</a></li>
          <li><a href="<?= BASE_URL ?>/index.php?page=volunteers">Get involved</a></li>   
          <?php if (!empty($_SESSION['is_admin'])): ?>
        ...
        <div class="footer-more-wrapper">
          ...
          <!-- <li><a href="<?= BASE_URL ?>/index.php?page=sponsors"></a></li> -->
          <!-- <li><a href="<?= BASE_URL ?>/index.php?page=news">News & Education</a></li>     -->
          <li><a href="index.php?page=home#aboutUs" >About Us</a></li>
        ...
        <ul class="footer-menu footer-menu-all" id="footerMenuAll">
          ...
          <li><a href="<?= BASE_URL ?>/index.php?page=dogs">Our Dogs</a></li> 
          <li><a href="<?= BASE_URL ?>/index.php?page=volunteers">Get involved</a></li>   
          <li><a href="<?= BASE_URL ?>/index.php?page=donations">Donations</a></li>
          <li><a href="<?= BASE_URL ?>/index.php?page=sponsors">Support Us</a></li>
          <li><a href="<?= BASE_URL ?>/index.php?page=news">News & Education</a></li>    
